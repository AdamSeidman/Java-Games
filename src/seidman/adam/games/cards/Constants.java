...
public class Constants {
	...
	protected static final HashMap<Integer, ArrayList<Index>> coordMap(int x, int y) {
		Index cardCenter = new Index(x + CARD_CENTER.getX(), y + CARD_CENTER.getY());
		...
		indexList.add(new Index(cardCenter.getX(), cardCenter.getY() - TWO_AND_THREE_OFFSET));
		indexList.add(new Index(cardCenter.getX(), cardCenter.getY() + TWO_AND_THREE_OFFSET));
		ret.put(2, indexList);
		indexList = new ArrayList<Index>();
		indexList.add(new Index(cardCenter.getX(), cardCenter.getY() - TWO_AND_THREE_OFFSET));
		...
		ret.put(3, indexList);
		indexList = new ArrayList<Index>();
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() - FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() - FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		ret.put(4, indexList);
		...
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY()));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY()));
		ret.put(6, indexList);
		indexList = new ArrayList<Index>();
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() - FOUR_THROUGH_TEN_OFFSET_Y));
		...
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() + FOUR_THROUGH_TEN_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() - OUTSIDE_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() - OUTSIDE_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() - OUTSIDE_OFFSET_X, cardCenter.getY() + OUTSIDE_OFFSET_Y));
		indexList.add(new Index(cardCenter.getX() + OUTSIDE_OFFSET_X, cardCenter.getY() + OUTSIDE_OFFSET_Y));
		indexList.add(cardCenter);
		...
		indexList = new ArrayList<Index>();
		indexList.add(new Index(cardCenter.getX(), cardCenter.getY() + FACE_OFFSET));
