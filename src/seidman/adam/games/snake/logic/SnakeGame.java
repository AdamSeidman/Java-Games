...
public class SnakeGame extends JPanel {
	...
	/**
	 * Picks a random unoccupied spot for a dot on the screen and places one there.
	 */
	...
	/**
	 * When a random dot is consumed, extend the snake and make each current Square
	 * last for one more update() call.
	 */
